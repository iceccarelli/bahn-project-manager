...
// Department column mapping from Excel (exact order + column indices from Übersichtsliste_Dashboard_1.xlsm)
const DEPARTMENT_MAPPING = [
  { dept: 'EEA', statusCol: 10, nameCol: 11, dateCol: 12 },
  { dept: 'ITK', statusCol: 13, nameCol: 14, dateCol: 15 },
  { dept: 'BS', statusCol: 16, nameCol: 17, dateCol: 18 },
...
async function main() {
  ...
  console.log('\nSeed complete! (For full fidelity with the uploaded Excel use POST /api/import/excel)');
}
